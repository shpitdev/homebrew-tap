...
class Osyrra < Formula
  ...
  on_macos do
    on_arm do
      url "https://api.github.com/repos/shpitdev/osyrra/releases/assets/434582712",
          using: OsyrraGitHubReleaseDownloadStrategy,
          resolved_basename: "osyrra_v0.0.19_darwin_arm64.tar.gz"
      sha256 "162a0231efcfc93e0c5967e349b0be925c98c2efe3fe6f933ba80dcade20a644"
    end
  end
